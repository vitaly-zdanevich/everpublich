...
def read_readme_html() -> str:
	"""Read the pre-rendered README snippet generated by embed_readme.py."""
	path = WEB / 'readme-embed.html'
	if path.exists():
		return path.read_text(encoding='utf-8')
	return '<p>README.md is not available yet.</p>'
